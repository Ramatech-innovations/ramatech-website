...
export function OpenShiftServiceCards({ items }: { items: CatalogItem[] }) {
  return (
      ...
      {items.map((item) => {
        ...
        return (
          <li key={item.slug}>
            ...
            >
              {item.comingSoon && (
                <span className="type-caption mb-2 text-brand-primary">
                  Coming soon
                </span>
              )}
              ...
              {isLive ? (
                ...
                <span className="type-caption mt-4 text-slate-500">
                  Available soon
                </span>
              )}
            </Card>
