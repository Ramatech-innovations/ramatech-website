...
export function WhatsAppFloatButton() {
  return (
    ...
    >
      <span
        className="pointer-events-none hidden whitespace-nowrap rounded-full border border-slate-200/80 bg-white px-3 py-1.5 text-sm font-medium text-slate-700 shadow-md opacity-0 transition-opacity duration-200 group-hover:opacity-100 md:block"
        aria-hidden
      >
        Chat with us
      </span>
      <span className="flex h-14 w-14 shrink-0 items-center justify-center rounded-full bg-white shadow-lg ring-1 ring-black/5">
